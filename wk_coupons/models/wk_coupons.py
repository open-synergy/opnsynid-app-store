...
class VoucherVoucher(models.Model):
    ...
    voucher_value = fields.Float(
        ...
        required=True,
        default=_get_default_voucher_value
    )
    note = fields.Text(
        string="Description",
    ...
    active = fields.Boolean(
        string="Active",
        help="By unchecking the active field you can disable this voucher without deleting it.",
        default=1
    )
    ...
    voucher_usage = fields.Selection(
        ...
        required=True,
        default=_get_default_voucher_usage,
    ...
    customer_type = fields.Selection(
        ...
        required=True,
        default=_get_default_customer_type,
        string="Coupon for",
        help="On choosing the General the coupon can be applied for all customers, "
             "and on choosing the Special Customer the Coupon can be used for a particlar customer "
             "and can be partially redeemed.If the customer type is choosen as new Customers "
             "the coupon will be appllied for new registered customers."
    )
    is_partially_redemed = fields.Boolean(
        string="Use Partial Redemption",
        default=_get_default_partital_use,
    ...
    redeemption_limit = fields.Integer(
        ...
        required=True,
        default=-1,
        help="The maximum number of times the coupon can be redeemed. "
             "-1 means the coupon can be used any number of times untill the voucher value is Zero."
    )
    use_minumum_cart_value = fields.Boolean(
        string="Use Cart Amount Validation",
        default=_get_default_use_cart_limit,
    ...
    minimum_cart_amount = fields.Float(
        ...
        default=_get_default_cart_limit_value,
